...
class FeatureGen:
    def __init__(self, df, target_cols: list = None, degree: int = 2, interaction_only: bool = False,
                 include_bias: bool = True, feature_gen: str = 'poly'):
        """
    ...
    def fit_transform(self):
        if self.feature_gen == 'poly':
            polynomial = preprocessing.PolynomialFeatures(self.degree, self.interaction_only, self.include_bias)
